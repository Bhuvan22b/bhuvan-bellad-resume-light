      ...
      <div className="relative p-6">
        <div className="text-center mb-8">
          <div className="mb-4 relative">
            <div className="absolute inset-0 bg-gradient-to-r from-blue-400 to-purple-600 rounded-full blur-md opacity-30 scale-110"></div>
            <img 
          ...
          <div className="mt-2 w-16 h-1 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full mx-auto"></div>
        </div>
            ...
            return (
              <li key={item.id} className="transform transition-all duration-200 hover:scale-105">
                <button
                  ...
                  className="w-full flex items-center px-4 py-3 rounded-xl transition-all duration-300 text-left text-gray-700 hover:bg-gradient-to-r hover:from-blue-500 hover:to-purple-600 hover:text-white group hover:shadow-lg hover:shadow-blue-500/25 relative overflow-hidden"
        ...
        <div className="mt-8 p-4 bg-gradient-to-r from-blue-500/10 to-purple-600/10 rounded-xl border border-blue-200/50">
