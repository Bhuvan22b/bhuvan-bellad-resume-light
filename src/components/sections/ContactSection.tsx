  ...
  return (
    <section className="relative">
      <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200/50 p-8 mb-6 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-36 h-36 bg-gradient-to-br from-blue-400/20 to-red-500/20 rounded-full blur-xl"></div>
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-4 mb-8">
            <div className="p-3 bg-gradient-to-r from-blue-600 to-red-600 rounded-xl shadow-lg">
            ...
            <div>
              ...
              <div className="w-20 h-1 bg-gradient-to-r from-blue-600 to-red-600 rounded-full mt-2"></div>
            </div>
          </div>
