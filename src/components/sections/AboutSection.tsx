        ...
        <div className="relative z-10">
          <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8 mb-6">
            <div className="flex-shrink-0 relative">
              <div className="absolute inset-0 bg-gradient-to-r from-blue-400 to-purple-600 rounded-2xl blur-lg opacity-30 scale-105"></div>
              <img 
              ...
              <div className="space-y-4">
                <div className="p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200/50">
                  <p className="text-gray-700 text-lg leading-relaxed">
                    ...
                    <span className="font-semibold text-purple-600"> RV University</span>, currently in my 2nd year (2023 batch, graduating in 2027). 
                ...
                <div className="p-6 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl border border-purple-200/50">
                  <p className="text-gray-700 text-lg leading-relaxed">
                    I'm particularly interested in <span className="font-semibold text-purple-600">AI/ML</span>, 
